...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(DUNDUNSPARCE),
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_CHARCADET - 1]       = ANIM_BACK_AND_LUNGE,
    [SPECIES_ARMAROUGE - 1]       = ANIM_BACK_AND_LUNGE,
    [SPECIES_CERULEDGE - 1]       = ANIM_BACK_AND_LUNGE,
    [SPECIES_WATTREL - 1]       = ANIM_RAPID_H_HOPS,
    [SPECIES_KILOWATTREL - 1]       = ANIM_RAPID_H_HOPS,
    [SPECIES_TOEDSCOOL - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TOEDSCRUEL - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CAPSAKID - 1]       = ANIM_V_SHAKE_TWICE,
    [SPECIES_SCOVILLAIN - 1]       = ANIM_V_SHAKE_TWICE,
    [SPECIES_TINKATINK - 1]       = ANIM_H_STRETCH,
    [SPECIES_TINKATUFF - 1]       = ANIM_H_STRETCH,
    [SPECIES_TINKATON - 1]       = ANIM_H_STRETCH,
    [SPECIES_CETODDLE - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_CETITAN - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_ANNIHILAPE - 1]       = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_CLODSIRE - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_FARIGIRAF - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DUNDUNSPARCE - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_KINGAMBIT - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_GREAT_TUSK - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_SLITHER_WING - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_IRON_TREADS - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_IRON_MOTH - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_FRIGIBAX - 1]       = ANIM_BACK_AND_LUNGE,
    [SPECIES_ARCTIBAX - 1]       = ANIM_BACK_AND_LUNGE,
    [SPECIES_BAXCALIBUR - 1]       = ANIM_BACK_AND_LUNGE,
    [SPECIES_ROARING_MOON - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_IRON_VALIANT - 1]       = ANIM_GROW_VIBRATE,
    [SPECIES_POLTCHAGEIST - 1]       = ANIM_FIGURE_8,
    [SPECIES_SINISTCHA - 1]       = ANIM_FIGURE_8,
