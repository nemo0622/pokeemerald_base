...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_FUECOCO]                    = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CROCALOR]                    = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SKELEDIRGE]                    = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_QUAXLY]                    = BACK_ANIM_H_STRETCH,
    [SPECIES_QUAXWELL]                    = BACK_ANIM_H_STRETCH,
    [SPECIES_QUAQUAVAL]                    = BACK_ANIM_H_STRETCH,
    [SPECIES_CHARCADET]                    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_ARMAROUGE]                    = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_CETODDLE]                    = BACK_ANIM_H_STRETCH,
    [SPECIES_CETITAN]                    = BACK_ANIM_H_STRETCH,
    ...
    [SPECIES_DUNDUNSPARCE]                    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_KINGAMBIT]                    = BACK_ANIM_GROW_STUTTER,
    [SPECIES_GREAT_TUSK]                    = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_SLITHER_WING]                    = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_IRON_TREADS]                    = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_IRON_MOTH]                    = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_FRIGIBAX]                    = BACK_ANIM_H_SHAKE,
    [SPECIES_ARCTIBAX]                    = BACK_ANIM_H_SHAKE,
    [SPECIES_BAXCALIBUR]                    = BACK_ANIM_H_SHAKE,
    [SPECIES_ROARING_MOON]                    = BACK_ANIM_H_SHAKE,
    [SPECIES_IRON_VALIANT]                    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_POLTCHAGEIST]                    = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_SINISTCHA]                    = BACK_ANIM_CONVEX_DOUBLE_ARC,
